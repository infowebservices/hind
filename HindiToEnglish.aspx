...
<head runat="server">
    ...
    target += result.translation;
       document.getElementById('span123').innerHTML = target;
    document.getElementById('txtUnicode').value =  document.getElementById('span123').innerHTML;
    ...
    if(!doTranslation)
    return;
    // Transalte(document.getElementById('hidSourceCode').value,'hi','en');
                ...
                {
               //  doTranslation = false;
                     Transalte(source.substring(indx,indx+batchSiz), "hi", "en");
                }
                indx += batchSiz;
...
var pop ='<div id ="divPopUp" style="position:absolute;top:200px;"  class="popUp"><iframe src="SendEmail.aspx" scrolling="no" height="130px" width="470px" ></iframe></div>';
...
<body>
            ...
            <td align="center">
                <div class="panel">
                    ...
                    केवल .docx या .txt फ़ाइलें स्वीकार किए जाते हैं<img src="images/close.jpg" style="height:10px;width:10px" />
                                                ...
                                                Women&#39;s Day evening red carpet, sparkling stars, Aroshnioan, cameras and Ssparmadal
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" class="UniCodeFont">
    ...
    <div id="divUniCode" runat="server" class="panel">
        ...
        <table id="tblUniCode" runat="server" width="100%">
            <tr>
                <td align="center" style="width: 100%">
                   <span ID="imgLoading" style="position:relative;top:200px" >   <asp:Image  runat="server" ImageUrl="images/loading.gif" /></span>
                    ...
                    <asp:TextBox ID="txtUnicode" runat="server" TextMode="MultiLine" BackColor="Gray"
                        ...
                        Style="cursor: default; overflow: auto; width: 98%" ForeColor="White" BorderColor="#0F0F0F"
